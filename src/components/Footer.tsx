  ...
  return (
    <footer className="bg-black border-t border-white/10">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        {/* Main Footer Content */}
        <div className="py-12 md:py-16 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
          {/* Brand & Description */}
          <div className="max-w-md">
            <a
              href="#"
              className="group bai-jamjuree text-2xl font-bold text-white hover:text-orange-500 uppercase tracking-tight"
            >
              Qusai
            ...
            <p className="space-grotesk text-white/50 mt-4 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8 lg:gap-12">
            ...
            <div className="space-y-2">
              <a
                ...
                className="block space-grotesk text-white/70 hover:text-orange-500 transition-colors duration-300"
              >
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center text-white/50 hover:bg-orange-500 hover:text-white transition-all duration-300"
                aria-label="GitHub"
              >
                <svg
                  className="w-5 h-5"
